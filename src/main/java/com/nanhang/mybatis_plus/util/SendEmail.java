...
public class SendEmail {
    ...
    public static String myEmailAccount = "zhougr0714@163.com";
    public static String myEmailPassword = "CULXTHBHSENNMPWG";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "624914184@qq.com";
